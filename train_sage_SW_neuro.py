...
from modules import *
from data_loader import load_MP_Dos,load_SW_Dos_Betti,load_SW_Dos_Betti_old,load_neuro_Dos_Betti
import warnings
...
def main():
    ...
    for dataset_name in data_names:
        ...
        data_list, X0, X1, y0 = load_neuro_Dos_Betti("DynHCPAge")
